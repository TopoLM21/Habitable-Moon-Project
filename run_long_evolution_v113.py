#!/usr/bin/env python3
"""Moon Tectonics v0.13 topology-hysteresis checkpoint/resume runner.
...
def parse_args():
    p=argparse.ArgumentParser(description='v0.13 physical-topology + microplate hysteresis conservative long integration')
