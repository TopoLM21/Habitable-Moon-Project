#!/usr/bin/env python3
"""Moon Tectonics v0.15 material-aware topography + passive-hydrosphere checkpoint/resume runner.
...
def parse_args():
    p=argparse.ArgumentParser(description='v0.15 material-aware isostasy/topography + v0.14 conserved-water sea level')
    p.add_argument('--config',default='configs/canonical_moon.yaml')
    p.add_argument('--output',default='outputs_v115_material_topography')
