#!/usr/bin/env python3
"""v0.9.6 checkpoint/resume runner for long tectonic integrations.
...
def parse_args():
    p=argparse.ArgumentParser(description='v0.9.6 long integration with progressive continental collision/welding')
