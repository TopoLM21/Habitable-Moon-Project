#!/usr/bin/env python3
"""Moon Tectonics v0.11 material-layer checkpoint/resume runner.
...
def parse_args():
    p=argparse.ArgumentParser(description='v0.11 material-layer conservative long integration')
...
def main():
    ...
    if a.finalize:
        ...
        with (out/'summary_v110.json').open('w',encoding='utf-8') as h:json.dump(summary,h,ensure_ascii=False,indent=2)
