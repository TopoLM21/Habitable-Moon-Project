...
def simulation_environment(spec: RunSpec) -> QProcessEnvironment:
    """Prepare the numerical child environment for this workspace."""
...
class SimulationController(QObject):
    ...
    def start(self, spec: RunSpec) -> None:
        ...
        mode = "optimized CPU" if spec.cpu_optimized else "reference CPU"
        self.log_line.emit(f"Execution: {mode}; fast assignment={spec.assignment_optimized}.")
