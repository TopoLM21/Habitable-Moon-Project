#!/usr/bin/env python3
"""Moon Tectonics v0.17 thermal/GPE ridge-push checkpoint/resume runner.
...
def parse_args():
    p=argparse.ArgumentParser(description='v0.17 thermal/GPE ridge push + v0.16 crust/mantle-lithosphere split')
...
def main():
    ...
    if a.finalize:
        ...
        with (out/'summary_v117.json').open('w',encoding='utf-8') as h:json.dump(summary,h,ensure_ascii=False,indent=2)
