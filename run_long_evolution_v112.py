#!/usr/bin/env python3
"""Moon Tectonics v0.12 physical-topology checkpoint/resume runner.
...
def parse_args():
    p=argparse.ArgumentParser(description='v0.12 physical-topology conservative long integration')
    p.add_argument('--config',default='configs/canonical_moon.yaml')
    p.add_argument('--output',default='outputs_v110_material')
