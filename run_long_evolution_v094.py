#!/usr/bin/env python3
"""v0.9.4 checkpoint/resume runner for long tectonic integrations.
...
def parse_args():
    p=argparse.ArgumentParser(description='v0.9.4 long integration with late internal boundary nucleation')
    p.add_argument('--config',default='configs/canonical_moon.yaml')
    p.add_argument('--output',default='outputs_v094_long')
