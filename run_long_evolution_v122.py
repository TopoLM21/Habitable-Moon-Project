#!/usr/bin/env python3
"""Moon Tectonics v0.22 flexural-isostasy runner.
...
def parse_args():
    p=argparse.ArgumentParser(description='v0.22 flexural isostasy')
    p.add_argument('--config',default='configs/canonical_moon.yaml')
    p.add_argument('--output',default='outputs_v122_flexure')
...
def main():
    ...
    if a.finalize:
        ...
        with (out/'summary_v122.json').open('w',encoding='utf-8') as h:json.dump(summary,h,ensure_ascii=False,indent=2)
